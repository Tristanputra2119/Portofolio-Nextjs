...
function ContactForm() {
                    ...
                    <div className="flex flex-wrap -m-4 justify-center">
                        <div className="p-4 mt-36 w-2/3 sm:w-1/2 lg:w-1/3 bg-[#F1F1F1] rounded-xl">
                            ...
                            <div className="flex items-center flex-wrap justify-center ">
                                <a href=""><button className="edu-box hover:cursor-pointer">Back to home page</button>
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    return (
        <section id="contact" className="bg-white body-font relative">
                    ...
                    <div className="flex flex-wrap -m-2 justify-center">
                        ...
                        <section id="footer">
                            <div className="w-full pt-8 mt-8 border-t border-gray-800 text-center">
                                <a className="text-[#1E1E1E] hover:text-[#70667a] block leading-normal my-5 text-lg" href="mailto:ngurah.tristanputra@gmail.com">ngurah.tristanputra@gmail.com</a>
                                <span className="inline-flex pb-5">
                                    <a className="ml-4 text-[#1E1E1E] hover:text-[#70667a]" href="https://www.instagram.com/triznx_/" target="_blank">
                                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
                                            <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                                            <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                                        </svg>
                                    </a>
                                    <a href="https://github.com/Tristanputra2119/" target="_blank" className="ml-4 text-[#1E1E1E] hover:text-[#70667a]">
